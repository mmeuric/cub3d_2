...
\
				handler_colors_and_textures.c get_map.c garbage_collector.c  color.c \
\
\
...
\
				...
				tools_tab.c tools_file.c tools_str.c error.c \
				map_element.c init_perso.c \
				check_map_error.c \
				side_pers.c move.c wall.c raycasting.c handler_parse_textures.c \
