...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/13 20:26:01 by urlooved &&       #+#    #+#             */
/*   Updated: 2025/05/14 13:36:52 by urlooved &&      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (i == 0 || i == array_len(map) - 1 || j == 0 || j == (int)ft_strlen(map[0]) - 1)
		return (false);
...
//! should be called is_cardinal_player.
