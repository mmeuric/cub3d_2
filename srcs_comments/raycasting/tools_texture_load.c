...
/*   Updated: 2025/05/17 15:21:31 by urlooved &&      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	import_textures(t_game *game)
{
	...
	decode_image_asset(game, game->mlx_data->texture[0], game->map_data->n_texture, &img);
	decode_image_asset(game, game->mlx_data->texture[1], game->map_data->s_texture, &img);
	decode_image_asset(game, game->mlx_data->texture[2], game->map_data->e_texture, &img);
	decode_image_asset(game, game->mlx_data->texture[3], game->map_data->w_texture, &img);
}