...
static void	extract_file_raw_data(t_engine *eng, char *file_name) // old named get_file_content
{
	int		fd;
	int		i;
	char	*line;
...
void	handler_input_file(t_engine *eng, char **av)
{
	...
	handler_colors_and_textures(eng); 										// Will init / parse textures & colors //* 50% textures 50% colors 
