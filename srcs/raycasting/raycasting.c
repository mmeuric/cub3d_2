...
//! Handler. But also mixing init i think. These function should be better partitionated
void	play(t_engine *eng)
{
	eng->mlx_data->mlx = mlx_init();
	init_perso(eng);										//TODO could be part of handler_input_file where i'm initing / parsing everything. 
